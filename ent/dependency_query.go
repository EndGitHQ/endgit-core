...
type DependencyQuery struct {
	...
	withParentVersion *VersionQuery
...
// QueryParentVersion chains the current query on the "parentVersion" edge.
func (_q *DependencyQuery) QueryParentVersion() *VersionQuery {
...
func (_q *DependencyQuery) Clone() *DependencyQuery {
	...
	return &DependencyQuery{
		...
		withParentVersion: _q.withParentVersion.Clone(),
...
// WithParentVersion tells the query-builder to eager-load the nodes that are connected to
// the "parentVersion" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *DependencyQuery) WithParentVersion(opts ...func(*VersionQuery)) *DependencyQuery {
	query := (&VersionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withParentVersion = query
	return _q
}
...
func (_q *DependencyQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Dependency, error) {
	...
	if query := _q.withParentVersion; query != nil {
		if err := _q.loadParentVersion(ctx, query, nodes, nil,
			func(n *Dependency, e *Version) { n.Edges.ParentVersion = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DependencyQuery) loadParentVersion(ctx context.Context, query *VersionQuery, nodes []*Dependency, init func(*Dependency), assign func(*Dependency, *Version)) error {
...
func (_q *DependencyQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withParentVersion != nil {
			_spec.Node.AddColumnOnce(dependency.FieldVersionId)
		}
	}
